...
export const KEYPAD_PHONES: KeypadPhone[] = [
  // Nokia
  { id: "nokia105", brand: "Nokia", name: "Nokia 105 (2023)", image: "https://fdn2.gsmarena.com/vv/bigpic/nokia-105-2023.jpg" },
  { id: "nokia110", brand: "Nokia", name: "Nokia 110 4G", image: "https://fdn2.gsmarena.com/vv/bigpic/nokia-110-4g-2023.jpg" },
  { id: "nokia130", brand: "Nokia", name: "Nokia 130 Music", image: "https://fdn2.gsmarena.com/vv/bigpic/nokia-130-music.jpg" },
  { id: "nokia150", brand: "Nokia", name: "Nokia 150 (2023)", image: "https://fdn2.gsmarena.com/vv/bigpic/nokia-150-2023.jpg" },
  { id: "nokia225", brand: "Nokia", name: "Nokia 225 4G", image: "https://fdn2.gsmarena.com/vv/bigpic/nokia-225-4g.jpg" },
  // Samsung Guru / Keypad
  { id: "samsguru", brand: "Samsung", name: "Samsung Guru Music 2", image: "https://fdn2.gsmarena.com/vv/bigpic/samsung-b310e.jpg" },
  { id: "samsgurumx", brand: "Samsung", name: "Samsung Metro XL", image: "https://fdn2.gsmarena.com/vv/bigpic/samsung-metro-xl.jpg" },
  // itel Keypad
  { id: "itel2173", brand: "itel", name: "itel it2173", image: "https://fdn2.gsmarena.com/vv/bigpic/itel-it2173.jpg" },
  { id: "itel5026", brand: "itel", name: "itel Magic 2 4G", image: "https://fdn2.gsmarena.com/vv/bigpic/itel-magic-2.jpg" },
  // QMobile / Jazz
  { id: "qm270", brand: "QMobile", name: "QMobile K270", image: "https://fdn2.gsmarena.com/vv/bigpic/qmobile-k-touch-4g.jpg" },
  { id: "jazz4g", brand: "Jazz", name: "Jazz Digit 4G", image: "https://fdn2.gsmarena.com/vv/bigpic/jazz-digit-4g.jpg" },
];


export const SERVICES = [
  { icon: Wrench, title: "Screen Replacement", desc: "Original LCD & OLED panels with 30-day warranty." },
  { icon: ShieldCheck, title: "Battery Replacement", desc: "100% health original batteries for all brands." },
  { icon: Phone, title: "Software & IMEI Repair", desc: "Flashing, unlocking, iCloud & FRP solutions." },
  { icon: Wrench, title: "Board & Charging Repair", desc: "Micro-soldering, charging port & camera repair." },
];

export type Accessory = { id: string; name: string; category: string; desc: string; emoji: string };

export const ACCESSORIES: Accessory[] = [
  { id: "handsfree",   emoji: "🎧", category: "Audio",     name: "Original Handsfree",           desc: "Samsung, Oppo, Vivo, iPhone type-C & 3.5mm — original & A-grade options." },
  { id: "airpods",     emoji: "🎧", category: "Audio",     name: "Bluetooth Earbuds / AirPods",   desc: "TWS earbuds, AirPods Pro copy & original — with warranty." },
  { id: "neckband",    emoji: "🎧", category: "Audio",     name: "Bluetooth Neckband",            desc: "JBL, Realme, Oraimo — long battery, HD mic." },
  { id: "speaker",     emoji: "🔊", category: "Audio",     name: "Bluetooth Speaker",             desc: "JBL, Anker, Boat — bass-boost portable speakers." },

  { id: "charger",     emoji: "🔌", category: "Charging",  name: "Original Charger (Fast)",       desc: "Samsung 25W, Oppo VOOC, iPhone 20W PD, Xiaomi 33W & more." },
  { id: "cable",       emoji: "🔗", category: "Charging",  name: "Data / Charging Cable",         desc: "Type-C, Micro-USB, iPhone Lightning — fast-charge braided cables." },
  { id: "powerbank",   emoji: "🔋", category: "Charging",  name: "Power Bank 10,000 – 20,000 mAh", desc: "Anker, Baseus, Romoss — PD fast charging." },
  { id: "carcharge",   emoji: "🚗", category: "Charging",  name: "Car Charger",                   desc: "Dual USB, Type-C PD & QC 3.0 car chargers." },
  { id: "wireless",    emoji: "⚡", category: "Charging",  name: "Wireless Charger 15W",          desc: "Qi wireless pads for iPhone & Android." },

  { id: "memory",      emoji: "💾", category: "Storage",   name: "Memory Card (SanDisk)",         desc: "16GB, 32GB, 64GB, 128GB, 256GB Class-10 & Ultra." },
  { id: "usb",         emoji: "💽", category: "Storage",   name: "USB Flash Drive",               desc: "SanDisk, HP 16GB–128GB, USB 2.0 & 3.0." },
  { id: "otg",         emoji: "🔌", category: "Storage",   name: "OTG / Card Reader",             desc: "Type-C OTG, all-in-one SD + micro-SD card readers." },

  { id: "cover",       emoji: "📱", category: "Protection", name: "Back Cover / Case",            desc: "Silicone, hard-shell, magnetic & branded cases for every model." },
  { id: "glass",       emoji: "🛡️", category: "Protection", name: "Tempered Glass Protector",     desc: "9H, full-glue, matte, privacy & ceramic protectors — free installation." },
  { id: "pouch",       emoji: "👜", category: "Protection", name: "Leather Wallet Pouch",         desc: "Universal & model-fit leather pouches with card slots." },

  { id: "holder",      emoji: "🚙", category: "Mounts",     name: "Mobile Car Holder",             desc: "Dashboard, AC-vent & magnetic phone holders." },
  { id: "selfie",      emoji: "🤳", category: "Mounts",     name: "Selfie Stick / Tripod",         desc: "Bluetooth tripod with remote, ring-light tripod." },
  { id: "ringlight",   emoji: "💡", category: "Mounts",     name: "Ring Light 10\"–18\"",           desc: "For TikTok, YouTube & video calls." },

  { id: "smartwatch",  emoji: "⌚", category: "Wearables",  name: "Smart Watch",                   desc: "T500, HW68, Ultra series, Amazfit — call & fitness watches." },
  { id: "band",        emoji: "📿", category: "Wearables",  name: "Fitness Band",                  desc: "Mi Band, Realme Band — heart-rate & step tracking." },

  { id: "simadapter",  emoji: "📶", category: "Extras",     name: "SIM Ejector + Adapter Kit",     desc: "Nano / Micro / Standard sim adapters & ejector pins." },
  { id: "cleaning",    emoji: "🧴", category: "Extras",     name: "Screen Cleaning Kit",           desc: "Alcohol spray + microfiber cloth for phones & tablets." },
  { id: "stylus",      emoji: "✏️", category: "Extras",     name: "Universal Stylus Pen",          desc: "Capacitive stylus for iPad, tablets & smartphones." },
];
